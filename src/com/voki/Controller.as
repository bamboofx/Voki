package com.voki
{
	...
	public class Controller extends EventDispatcher {
		...
		public function Controller($playerHolder:MovieClip) {
			playerHolder = $playerHolder;
			defaultEngine = new EngineStruct("assets/engineV5.swf", 42, "2D");
		...
		public function init($showUrl:String):void {
			...
			playerHolder.addChild(_engine);
						
			showUrl = $showUrl;
			
			var url:String;
			url= "assets/vhss_v5.swf";
...
//			{
			var sesh:* = SessionVars;
			SessionVars.charEdit_engineUrl = "assets/engineV5.swf";
			SessionVars.charEdit_oh = "assets/ovh2.swf";
			...
			SessionVars.charEdit_name = "";
				...
				//var shs:HostStruct = new HostStruct(SessionVars.charEdit_oh, 5,"host_2d");
				//shs.engine = new EngineStruct(SessionVars.charEdit_engineUrl);
				
				show = new ShowStruct();				
				show.scene = new SceneStruct();
				curScene = show.scene;
				shs.host_container = new MovieClip();
				playerHolder.addChild(shs.host_container);
				
				shs.model_ptr = new MovieClip();
				playerHolder.addChild(shs.model_ptr);
				
				shs.display_obj = new MovieClip();
				playerHolder.addChild(shs.display_obj);
				
				shs.loader = new Loader();
...
//			}
		...
		public function get engineAPI():EngineV5 {
			return _engine;			
			///return(player.getActiveEngineAPI());
		}
		public function get controller():VHostConfigController {
			//trace("player = " + player);
		...
		public function loadAccessory($acc:AccessoryData):void {
			...
			_engine.model.removeInitialAccessory($acc.typeId);
