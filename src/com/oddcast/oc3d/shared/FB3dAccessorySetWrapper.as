package com.oddcast.oc3d.shared
{
	...
	public class FB3dAccessorySetWrapper
	{
		...
		public function FB3dAccessorySetWrapper(sprite:Sprite, accessorySetId:int, modelId:int, contentProvider:IContentProvider, oc3dEngineUrl:String, bootScript:String, head:IHeadPlugin, continuationFn:Function, failedFn:Function, progressedFn:Function=null):void
		{
			...
			{
				engine_ = IEngine3D(factory.createObject("IEngine3D", 1, [contentProvider_]));
		...
		public function executeCommand(commandName:String, arg:Array=null):void
		{
			if (state_ >= LOADED)
			{
				var cmds:Array = aSet_.children([ICommandProxy]);
				...
				if (arg != null)
					for (var i:uint=0; i<arg.length; ++i)
						if (arg[i] is Function)
							arg[i] = (function(f:Function):Function{ return function(a:*, b:*):void{ f(); }; })(arg[i] as Function);

				found.invokeWithArray(arg==null?[]:arg);
			}
			else
				throw new Error("wrapper not loaded");
		}
			...
			progressedFn:Function=null):void
		{
			if (state_ >= LOADED)
			{
				Util.loadSoundAndPlayVisemeOnAllAvailableMorphDeformers
				(
					builder_,
					url,
					triggerAudio,
