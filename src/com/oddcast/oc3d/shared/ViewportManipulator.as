package com.oddcast.oc3d.shared
{
	...
	public class ViewportManipulator
	{
		...
		private function mouseMoveHandler(e:MouseEvent):void
		{
			...
			{
				var displacement1:Vector3D = DataUtil.Matrix_mulMatVecCopy(
					DataUtil.Matrix_createRotateVecWithRadians(camera.orientationInRadians()), 
			...
			else if (zoomingEnabled_ && e.ctrlKey) // zoom
			{
				...
				var displacement:Vector3D = DataUtil.Matrix_mulMatVecCopy(
					DataUtil.Matrix_createRotate(pitchDegrees_, yawDegrees_, 0), 
					Maff.Vector3D_BACK);
			...
			else if (rotatingEnabled_) // rotate
			{
				...
				var displacement3:Vector3D = DataUtil.Matrix_mulMatVecCopy(
					DataUtil.Matrix_createRotate(pitchDegrees_, yawDegrees_, 0), 
					Maff.Vector3D_BACK);
