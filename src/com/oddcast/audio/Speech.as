package com.oddcast.audio
{
	...
	public class Speech extends EventDispatcher
	{
		...
		private var _auto_say:Boolean = true;
		
		private var _instance_name:String;
		
		function Speech(url:String,fps:uint=12,percent:Number=0.5, speak:Boolean = true)
		{
		...
		{			
			...
			try
			{
				...
				setVolume(_volume); // make sure to maintain whatever volume was set previously 
		...
		public function isPreloadAudio():Boolean
		{
			return !_auto_say;
		}
