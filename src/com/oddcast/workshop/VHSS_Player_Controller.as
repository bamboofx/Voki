package com.oddcast.workshop
{
	...
	public class VHSS_Player_Controller
	{
		...
		public function load_and_init( _mid:int, 
									   ...
									   _listener_manager:Listener_Manager ):void
		{
			config = new Config( _mid, _player_url, _player_holder, _vhost_holder, _bg_holder, _full_body_mask, _callbacks, _talk_started, _talk_ended, _listener_manager );
		...
		private function init_loaded_player( _continue:Function, _key:Function ):void
		{
			...
			// TODO ADD full body workshop info
//			var mask_width:Number = ui_player.fb_mask.width;
//			var mask_height:Number = ui_player.fb_mask.height
//			player_api.set3DSceneSize(mask_width, mask_height);
